var template =
`
<div class="alert alert-dismissible fade" :class="[type ? 'alert-' + type : '']">
  <button type="button" class="close" :visible="!autoClose" :click="close"><span aria-hidden="true">×</span></button>
